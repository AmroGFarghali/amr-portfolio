  ...
  return (
    <Card className="overflow-hidden border hover:shadow-lg pt-0 pb-3">
      <img
        src={image}
        alt=""
        className="h-[200px] object-top object-cover overflow-hidden "
      />
      ...
      <CardFooter className="px-2 mt-auto flex flex-col items-start">
        ...
        <div id="links" className="mt-2 flex gap-2">
          {deployLink && (
            <a href={deployLink} target="_blank">
              <Badge className="flex items-center gap-2 p-1 px-2 cursor-pointer">
                <Globe />
                Website
              </Badge>
            </a>
