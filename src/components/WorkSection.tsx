...
const workData = [
  {
    ...
    description:
      "Completed an intensive MEARN stack program culminating in a capstone group project: an AI-powered recruitment system designed to streamline the hiring process. The system features company profile management, job posting creation, CV parsing, AI-conducted interviews with automated feedback, applicant ranking, and integrated communication tools.",
  },
  {
    imageUrl: "pp2.jpg",
    companyName: "Nordra",
